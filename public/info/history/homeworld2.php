...
在銀河議會完全垮台後，隨之而來的是星塵戰爭（Dust Wars） ，這場戰爭一開始只是一些小規模的邊境衝突，但是很快的如星火燎原般越演越烈。差不多是這個時候，維格開始崛起。班圖西人和西亞加拉的凱蘭‧傑特（Karan S'jet）透過超空間核感應到第三個核心的存在。這一顆核心在統一維格各軍閥勢力的霸主麥肯（Makan）手上。維格在將泰丹叛軍併吞之後，了解到西亞加拉人以及班圖西人也擁有超空間核而欲搶奪之。趁著星塵戰爭機會，來自銀河的東方邊境的維格大軍席捲了整個銀河。這時候的西亞加拉人轉而向古老的預言求助。
...
在平息了戰爭的威脅之後，銀河自千年以來的動盪鬥爭中回覆和平。古老的貿易航線再度興旺發達。之後，埃朗之眼被發現了。藉著沙鳩克和三核的力量被打開的埃朗之眼是一個巨大的先祖超空間網路的入口。這個網路橫跨了整個銀河，以往需要數個月航程的距離，現在只要一瞬間就能到達。為了紀念打開埃朗之眼的凱蘭‧傑特，這個偉大的奇蹟與夢想的時代被稱為傑特時代。
MC
];
